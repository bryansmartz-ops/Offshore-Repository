...
const KNOWN_STRUCTURES = [
  ...
  { name: "Wilmington Canyon", lat: 38.5, lon: -73.495, depth: "600-1800ft", type: 'canyon' },
  { name: "Spencer Canyon", lat: 38.608333, lon: -73.213333, depth: "600-1500ft", type: 'canyon' },
  { name: "Lindenkohl Canyon", lat: 38.796667, lon: -73.028333, depth: "600-1500ft", type: 'canyon' },
